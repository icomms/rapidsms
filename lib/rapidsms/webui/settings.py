...
TEMPLATE_DIRS = [
    ...
    # temp to addition of gis template
    "/usr/local/lib/python2.6/dist-packages/Django-1.1.1-py2.6.egg/django/contrib/gis/templates"
]
...
logging.basicConfig(filename=RAPIDSMS_CONF["django-log"]["file"], level=logging.DEBUG)
